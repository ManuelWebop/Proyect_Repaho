            ...
            <div className="flex flex-row justify-center">
                ...
                <div className="flex-col w-[65%]">
                    ...
                    <div className="flex flex-row">
                        <Image src={publicDetails?.ImageUrl} width="2000" height="2000" className="h-[31rem] w-[40rem] rounded-lg" />
                        <div className="flex-col m-5 w-full">

                            <h1 className=" text-3xl font-semibold my-2">{publicDetails?.ubi}</h1>
                            <hr className='border border-black' />
                            <h2 className="mt-1 text-2xl font-thin text-black">${publicDetails?.price}</h2>
                            <div className="bg-white border border-black rounded-md my-5">
                    ...
                    <div className="flex flex-row my-4">
                        {
                            ...
                            publicDetails?.userId?._id.toString() === session?.user?._id.toString()
                                ? (
                                    <div className='flex flex-row mt-3 h-auto mb-10'>
                                ...
                                : (
                                    ...
                                    <div className="flex flex-row-reverse">
                                        ...
                                        <h3 className="text-xl mr-3">{publicDetails?.userId?.username}</h3>
                                    </div>
                                )
                        }
                    </div>
                    ...
                    <div className="flex flex-col my-10">
                        ...
                        <div className="flex flex-col shadow-black overflow-y-scroll bg-white">
                            <div className="m-1">
