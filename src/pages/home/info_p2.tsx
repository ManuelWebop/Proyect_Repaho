export default function Info_p2() {
    return (
        <div className="flex max-sm:flex-col justify-center" id="green">
            <div className="flex m-10 w-96 h-80 text-center rounded-lg bg-cover max-sm:h-1/2 max-sm:w-auto max-sm:items-center" id="uwu" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
                <p className="flex text-left text-3xl font-bold mt-28 m-20 text-white max-sm:m-5">Mas de 500 mil publicaciones</p>
            </div>
